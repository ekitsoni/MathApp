...
public class Test1 extends AppCompatActivity {
    ...
    int grade=0;
    String[] question1 = {"Απάντηση","0,001","0,1","0,01"};
    String[] question2 = {"Απάντηση","26","2,6","0,26"};
    String[] questionsSL = {"Απάντηση","Σωστό","Λάθος"};
    String[] answers = {"0,01", "2,6", "Λάθος", "Σωστό", "Λάθος", "Σωστό", "Σωστό", "Λάθος", "Σωστό", "Λάθος"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        endBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                MainActivity.setGrades(0,grade);
                startActivity(new Intent(Test1.this, Grades.class));
            }
        });
    }
}